    ...
    function renderinventory(filter = "") {
      ...
      inventory.forEach((item, index) => {
        ...
        newrow.innerHTML = `
          ...
          <td>${item.date}</td>
          <td>
            <button class="icon-only edit-button"><img src="https://cdn-icons-png.flaticon.com/512/8748/8748504.png" alt="Edit" /></button>
            <button class="icon-only delete-button"><img src="https://images.icon-icons.com/1808/PNG/512/trash-can_115312.png" alt="Remove" /></button>
          </td>
        `;
        newrow.querySelector(".edit-button").addEventListener("click", () => openedit(index));
    ...
    if (searchinput && searchbtn) {
      searchbtn.addEventListener("click", function () {
        ...
        if (query === "") {
          ...
          searchinput.value = "";
          setTimeout(() => searchinput.classList.remove("input-error"), 1000);
          return;
        }
